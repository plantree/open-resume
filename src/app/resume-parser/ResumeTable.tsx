  ...
  return (
    <table className="mt-2 w-full border text-sm text-gray-900">
      <tbody className="divide-y text-left align-top">
        ...
        <TableRow label="个人网站" value={resume.profile.url} />
        <TableRow label="个人简介" value={resume.profile.summary} />
        <TableRowHeader>教育背景</TableRowHeader>
        {educations.map((education, idx) => (
          <Fragment key={idx}>
            ...
            <TableRow label="时间" value={education.date} />
            <TableRow
              label="详细描述"
        ...
        {workExperiences.map((workExperience, idx) => (
          <Fragment key={idx}>
            ...
            <TableRow label="时间" value={workExperience.date} />
            <TableRow
              label="详细描述"
        ...
        {resume.projects.length > 0 && (
          <TableRowHeader>项目经验</TableRowHeader>
        )}
        {resume.projects.map((project, idx) => (
          <Fragment key={idx}>
            <TableRow label="项目名称" value={project.project} />
            <TableRow label="时间" value={project.date} />
            <TableRow
              label="详细描述"
        ...
        <TableRowHeader>技能特长</TableRowHeader>
        <TableRow label="技能描述" value={skills} />
      </tbody>
    </table>
  );
};
